    ...
    <div :class="['container', { 'container-top': searched }]">
      ...
      <div v-if="!searched" class="homepage-content">
        ...
        <div class="search-modes">
          <label>
            <input type="radio" name="searchMode" value="subtitle" v-model="searchMode"> Subtitle
          </label>
          <label>
            <input type="radio" name="searchMode" value="AIsubtitle" v-model="searchMode"> AI Subtitle
          </label>
          <label>
            <input type="radio" name="searchMode" value="Visual" v-model="searchMode"> Visual
          </label>
        </div>
      </div>
      ...
      <!-- No Results -->
      <div v-if="searched && videos.length === 0" class="no-results">No results!</div>
...
export default {
  ...
  methods: {
    async performSearch() {
      ...
      this.videos = data.filter(video => video.type === this.searchMode && video.contents.includes(this.searchQuery));
